...
public interface ActivityRepositoryMapper {
  ...
  ActivityImage activityImageEntityToActivityImage(ActivityImageEntity activityImageEntity);

  @Mapping(target = "activity.activityId", source = "activityId")
  ActivityImageEntity activityImageToActivityImageEntity(ActivityImage activityImage);
}
